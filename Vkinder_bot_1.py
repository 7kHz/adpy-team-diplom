            ...
            if event.to_me:
                ...
                if request.lower() == 'начать':
                    ...
                    if request.lower() == '\U0000279C':
                        intermidiate_list.append(generator_candidates(next(candidate_data)))
                    elif request.lower() == '\U00002605':
                        chosen_candidate_list.append(intermidiate_list.pop())
                        # вместо candidates вставить список избранных кандидатов
